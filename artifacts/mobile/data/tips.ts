...
export const TIPS: Tip[] = [
  ...
  },
  {
    ...
    content: "Celiac disease is a disability under the ADA. Venues with a 'no outside food' policy are required to make reasonable accommodations, including letting you bring your own safe food.\n\nBefore you go: contact the venue and let them know. Most say yes immediately once they understand it's a medical need.\n\nAt the door: 'I have celiac disease, which is covered by the ADA. I can't safely eat what's sold here and need to bring my own.' You don't need to explain further, but a doctor's note on your phone can help if staff push back.\n\nCovers concerts, stadiums, theme parks, and theaters. Private clubs may differ.",
  },
  {
    id: "t16",
    categoryId: "travel",
    title: "Snacks",
    content: "The best travel snacks are ones that won't melt in a hot car or a warm pocket and don't need refrigeration. Reach for high-protein options over high-sugar ones: protein keeps energy steady for hours, while sugar gives a quick spike and then a crash. Good options: individual packets of nut butter (almond, peanut, sunflower), beef or turkey jerky (check labels, as some use soy sauce or malt vinegar), roasted chickpeas, nuts and seeds, hard cheeses in sealed packaging, and rice cakes. Avoid chocolate bars or yogurt-covered anything in warm weather; they make a mess and the sugar hit fades fast.",
  },
  {
    id: "t9",
    categoryId: "travel",
